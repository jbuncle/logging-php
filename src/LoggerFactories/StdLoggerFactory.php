...
use JBuncle\Logging\Loggers\MultiLogger;
use JBuncle\Logging\Loggers\StreamLogger;
...
class StdLoggerFactory implements LoggerFactory {
    ...
    public function createLogger(): LoggerInterface {
        ...
        return new MultiLogger([
            new LogLevelLoggerFilter(
                    new StreamLogger(new StreamWrapper('php://stdout'), $formatter),
                    LogLevel::NOTICE,
                    LogLevelLoggerFilter::LESS_SEVERE
            ),
            new LogLevelLoggerFilter(
                    new StreamLogger(new StreamWrapper('php://stderr'), $formatter),
                    LogLevel::WARNING,
